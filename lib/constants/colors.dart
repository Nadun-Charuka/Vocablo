...
const Color kWarningIconColor = Colors.orange;
const Color kDarkSlateGray = Color(0xFF2F4F4F);

/// Neutral Colors
const Color kSoftLightGray = Color(0xFFF1F1F1);

/// Link Colors
const Color kTealLink = Color(0xFF1DE9B6);

/// Additional Text Colors
const Color kCharcoalGray = Color(0xFF616161);
