...
final ThemeData lightTheme = ThemeData(
  ...
  floatingActionButtonTheme: FloatingActionButtonThemeData(
    ...
    foregroundColor: const Color.fromARGB(255, 241, 252, 249),
  ),
  ...
  textTheme: TextTheme(
    ...
    titleMedium: TextStyle(color: kLightGreyColor),
  ),
...
final ThemeData darkTheme = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    titleMedium: TextStyle(color: kDarkGreyColor),
  ),
  ...
  bottomAppBarTheme: BottomAppBarTheme(color: kDarkBackgroundColor),
);
